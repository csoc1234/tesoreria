        ...
        <div class="card-body">
            ...
            <div v-if="formCargado">
                ...
                <div class="form-row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" @keypress='validarMaxLengthInt($event, 15)'
                                maxlength="15" class="form-control form-control-sm" v-model="usuario.identificacion"
                                placeholder="">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" @keypress='validarMaxLength($event, 140)'
                                maxlength="140" class="form-control form-control-sm" v-model="usuario.nombres"
                                placeholder="">
                ...
                <div class="form-row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" maxlength="140"
                                @keypress='validarMaxLength($event, 140)' class="form-control form-control-sm"
                                id="txtApellidos" v-model="usuario.apellidos" placeholder="">
                ...
                <div class="form-row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" autocomplete="off" @keypress='validarMaxLengthInt($event, 10)'
                                maxlength="10" class="form-control form-control-sm" id="txtTelefono"
                                v-model="usuario.telefono" placeholder="">
                            <span v-if="errors?.telefono" class="custom_error">@{{ errors.telefono }}</span>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="txtCelular"><b>Celular *</b></label>
                            <input type="number" autocomplete="off" maxlength="10"
                                @keypress='validarMaxLengthInt($event, 10)' class="form-control form-control-sm"
                                id="txtCelular" v-model="usuario.celular" placeholder="">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="email" maxlength="140" autocomplete="off"
                                @keypress='validarMaxLength($event, 140)' class="form-control form-control-sm"
                                id="txtEmail" v-model="usuario.email" placeholder="Email">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="500" autocomplete="off"
                                @keypress='validarMaxLength($event, 500)' class="form-control form-control-sm"
                                id="txtDireccion" v-model="usuario.direccion" placeholder="">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label v-if="tipoPeticion=='ADD'" for="txtPassword"><b>Contraseña *</b></label>
                            <label v-if="tipoPeticion=='EDIT'" for="txtPassword"><b>Nueva contraseña
                                    (opcional)</b></label>
                            <input type="password" onclick="this.removeAttribute('readonly');" maxlength="15"
                                @keypress='validarMaxLength($event, 15)' autocomplete="off"
                                class="form-control form-control-sm" v-model="usuario.password" id="txtPassword"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="cboEstado"><b>Estado *</b></label>
                                <select autocomplete="off" class="form-control form-control-sm" v-model="usuario.estado"
                                    id="cboEstado" placeholder="">
                                    <option value=''>Seleccione un item</option>
                                    <option value='1'>Activo</option>
                                    <option value='0'>Inactivo</option>
                                </select>
                                <span v-if="errors?.estado" class="custom_error">@{{ errors.estado }}</span>
                            </div>
                        </div>
                ...
                <div class="form-row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" v-model="usuario.tipo_vinculacion_id">
                                <option value="0" selected>Seleccione una opción</option>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" v-model="usuario.rol_id">
                                <option value="0" selected>Seleccione una opción</option>
                ...
                <div class="form-row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <vuejs-datepicker format="dd-MM-yyyy" input-class="form-control form-control-sm"
                                v-model="usuario.fecha_inicio_vinculacion" id="txtFechaInicioContrato" placeholder="">
                            </vuejs-datepicker>
                            <span v-if="errors?.fecha_inicio_vinculacion"
                                class="custom_error">@{{ errors.fecha_inicio_vinculacion }}</span>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <vuejs-datepicker format="dd-MM-yyyy" input-class="form-control form-control-sm"
                                v-model="usuario.fecha_fin_vinculacion" id="txtFechaFinContrato" placeholder="">
                            </vuejs-datepicker>
                ...
                <div class="form-row">
                    <div class="col-12">
                        <div class="form-group">
                            @if ($tipo == 'ADD' && Gate::check('check-authorization', PERMISO_REGISTRAR_USUARIOS))
                                <button name="btnGuardar" class="btn btn-success btn-sm" @click="eventoGuardarUsuario">
                                    <span v-if="spinners.enviarDatos" class="spinner-border spinner-border-sm"
                                        role="status" aria-hidden="true"></span>
                                    Guardar
                                </button>
                            @elseif($tipo == 'EDIT' && Gate::check('check-authorization', PERMISO_EDITAR_USUARIOS))
                                <button name="btnGuardar" class="btn btn-success btn-sm" @click="eventoEditarUsuario">
                                    <span v-if="spinners.enviarDatos" class="spinner-border spinner-border-sm"
                                        role="status" aria-hidden="true"></span>
                                    Guardar
                                </button>
                            ...
                            @if (Gate::check('check-authorization', PERMISO_BORRAR_USUARIO))
                                <button type="button" @click="borrarUsuario_click()" class="btn btn-danger btn-sm">
                                    <span v-if="spinners.borrarUsuario" class="spinner-border spinner-border-sm"
                                        role="status" aria-hidden="true"></span>
                                    Borrar usuario
                                </button>
                            @endif

                            @if (Gate::check('check-authorization', PERMISO_LISTAR_USUARIOS))
                                <a href="{{ URL::to('usuarios/index') }}" class="btn btn-secondary btn-sm">Listado de
                                    usuarios</a>
                            @endif
    ...
    const vueData = new Vue({
        ...
        data: {
            ...
            usuario: {
                ...
                estado: <?= !empty($usuario['estado']) ? "'" . $usuario['estado'] . "'" : "''" ?>,
                password: '',
        ...
        methods: {
            ...
            stopSpinners() {
              ...
              this.spinners.borrarUsuario = false;
            },
            ...
            cargarPermisos() {
                ...
                const ruta = 'usuarios/ajaxCargarRoles';
                const params = {};
                this.cargarDatos(ruta, params)
                    .then(response => {
                        this.listados['roles'] = response.data.listado;
                    })
                    .catch(error => {
            ...
            limpiarFormulario() {
                ...
                this.usuario.email = '';
                this.usuario.genero_id = 0;
                this.usuario.rol_id = 0;
                this.usuario.estado = '';
                this.usuario.password = '';
                this.usuario.celular = '';
                this.usuario.tipo_vinculacion_id = 0;
                this.usuario.fecha_inicio_vinculacion = '';
                this.usuario.fecha_fin_vinculacion = '';
            ...
            borrarUsuario(item) {
                ...
                const controlador = "usuarios/ajaxBorrarUsuario/" + usuarioId;
                this.spinners.borrarUsuario = true;
                this.cargarDatos(controlador, {}, 'DELETE').
                then(response => {
                    const data = response.data;
                    this.stopSpinners();
                    this.redirectUrl('usuarios/index');
                }).catch(error => {
                    this.stopSpinners();
                    const msg = 'Error al intentar realizar la operación';
